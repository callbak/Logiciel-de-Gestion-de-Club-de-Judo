...
{
    public partial class membershipsForm_modifyMembership : Form
    {
        ...
        public membershipsForm_modifyMembership ()
        {
            InitializeComponent();
        ...
        private async void MembershipsForm_modifyMembership_Load (object sender, EventArgs e)
        {
            try
            {
               await LoadAthlete();
