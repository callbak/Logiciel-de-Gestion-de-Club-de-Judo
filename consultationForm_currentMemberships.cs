...
{
    public partial class consultationForm_currentMemberships : Form
    {
        ...
        public consultationForm_currentMemberships ()
        {
            InitializeComponent();
        ...
        private void consultationForm_currentMemberships_Load (object sender, EventArgs e)
        {
            try
            {
                ...
                case 0:
                    {
                        ...
                        LoadActiveSubscriptions(1);
                        break;
                    }
                case 1:
                    {
                        ClearDataAndDataGrid();
                        LoadActiveSubscriptions(2);
                        break;
                    }
                default:
                    {
        ...
        private async void LoadActiveSubscriptions (int sport)
        {
            switch (sport)
            {
                case 1:
        ...
        private void DisplayFoundAthletes ()
        {
            ...
            {
                // add & get row
                int rowIndex = activeSubscriptionDataGrid.Rows.Add(AthleteName, SubId, SubEndDate);

                // get column of row
                DataGridViewCell subEndDate_cell = activeSubscriptionDataGrid.Rows[rowIndex].Cells[2];

                // customized column based on fetched value
                subEndDate_cell.Style.ForeColor = Color.Green;
            }
        }
        ...
        private void ClearDataAndDataGrid ()
        {
            ...
            activeSubscriptionDataGrid.Rows.Clear();
        }
        ...
        private void CenterControls ()
        {
            ...
            activeSubscriptionDataGrid.Height = (int)(this.ClientSize.Height * 0.75);
            activeSubscriptionDataGrid.Width = (int)(this.ClientSize.Width * 0.95);
            activeSubscriptionDataGrid.Location = new Point((this.ClientSize.Width - activeSubscriptionDataGrid.Width) / 2, 190);

            search_panel.Location = new Point(activeSubscriptionDataGrid.Location.X -14 , 90); 
        }
